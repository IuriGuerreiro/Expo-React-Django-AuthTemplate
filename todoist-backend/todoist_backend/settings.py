"""
Django settings for todoist_backend project.
...
MIDDLEWARE.append('todoist_backend.settings.custom_headers_middleware')

ROOT_URLCONF = 'todoist_backend.urls'
...
WSGI_APPLICATION = 'todoist_backend.wsgi.application'
